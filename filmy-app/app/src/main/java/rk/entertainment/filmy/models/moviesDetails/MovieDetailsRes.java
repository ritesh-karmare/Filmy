...
public class MovieDetailsRes {
    ...
    private List<ProductionCompanyData> productionCompanies = null;
 ...
 /*   @SerializedName("production_countries")
   ...
   /* @SerializedName("spoken_languages")
    ...
    public List<ProductionCompanyData> getProductionCompanies() {
        return productionCompanies;
    }

    public void setProductionCompanies(List<ProductionCompanyData> productionCompanies) {
