package rk.entertainment.movie_listing
...
import rk.entertainment.common.utils.ViewPagerAdapter
import rk.entertainment.movie_listing.databinding.ActivityMoviesMainBinding
...
class MoviesListingActivity : AppCompatActivity() {
    ...
    @Inject
    lateinit var searchMovieNavigation: SearchMovieNavigation
    ...
    private fun initListeners() {
        binding.ivSearch.setOnClickListener {
            val intent = searchMovieNavigation.newIntent(this)
