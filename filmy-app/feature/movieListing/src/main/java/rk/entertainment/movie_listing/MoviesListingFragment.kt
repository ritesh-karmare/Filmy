...
import rk.entertainment.movie_listing.databinding.FragmentMoviesListBinding
...
class MoviesListingFragment : Fragment(), MovieClickListener {
    ...
    override fun onMovieItemClicked(movieId: Int) {
        val intent =
            movieDetailsNavigation.newIntent(requireContext(), bundleOf(Pair("movieId", movieId)))
