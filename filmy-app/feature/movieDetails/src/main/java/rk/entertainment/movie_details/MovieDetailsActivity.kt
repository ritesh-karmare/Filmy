...
import rk.entertainment.common.models.moviesDetails.*
...
import rk.entertainment.common.utils.DateTimeUtil.getHoursAndMinutes
import rk.entertainment.common.utils.DateTimeUtil.getYearFromDate
...
import rk.entertainment.movie_details.databinding.ActivityMovieDetailsBinding
...
class MovieDetailsActivity : AppCompatActivity(), OnOffsetChangedListener, MovieClickListener {
    ...
    private fun initDots() {
        //init params
        val marginLeftRight = UIUtils.dpToPx(2f, this)
        val marginTopBottom = UIUtils.dpToPx(8f, this)
        val width = UIUtils.dpToPx(6f, this)
